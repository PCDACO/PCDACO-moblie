    ...
    <View className="gap-4">
      <FieldLayout label="Email">
        ...
        {form.formState.errors.email && (
          <TextUI className="text-sm text-red-500">{form.formState.errors.email.message}</TextUI>
        )}
      </FieldLayout>
      ...
      <FieldLayout label="Mật khẩu">
        ...
        {form.formState.errors.password && (
          <TextUI className="text-sm text-red-500">{form.formState.errors.password.message}</TextUI>
        )}
      </FieldLayout>
    </View>
  );
